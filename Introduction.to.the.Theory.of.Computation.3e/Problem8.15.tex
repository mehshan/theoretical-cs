...
\item \hspace*{1.0cm} Remove top most card $c$ from $C_1$.
\item \hspace*{1.0cm} Place $c$ on top of $S$ and recursively call $M$ on $\langle C_1, C_2, S, 2 \rangle$.
\item \hspace*{1.0cm} Remove $c$ from top of $S$.
\item \hspace*{1.0cm} Flip $c$, place it on top of $S$ and recursively call $M$ on $\langle C_1, C_2, S, 2 \rangle$.
...
\item \hspace*{1.0cm} Remove top most card $c$ from $C_2$.
\item \hspace*{1.0cm} Place $c$ on top of $S$ and recursively call $M$ on $\langle C_1, C_2, S, 2 \rangle$.
\item \hspace*{1.0cm} Remove $c$ from top of $S$.
\item \hspace*{1.0cm} Flip $c$, place it on top of $S$ and recursively call $M$ on $\langle C_1, C_2, S, 2 \rangle$.
