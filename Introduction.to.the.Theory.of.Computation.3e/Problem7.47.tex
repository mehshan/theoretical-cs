...
For example, a language in $\text{D}_{2}\text{P}$ is the difference of two NP languages. Sometimes $\text{D}_{2}\text{P}$ is called DP (and may be written $\text{D}^\text{P}$). Let
